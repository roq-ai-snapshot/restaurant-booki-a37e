  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Restaurant Booking Engine - Your complete solution for table reservations and menu management, seamlessly connecting customers and restaurant employees."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Restaurant Booking Engine - Your complete solution for table reservations and menu management, seamlessly connecting customers and restaurant employees.`}
            </Text>
            <Box
